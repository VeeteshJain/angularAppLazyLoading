  ...
  return {
    ...
    link: function(scope, element, attrs, accordionCtrl) {
      ...
      scope.$watch('isOpen', function(value) {
        //deep copy of variable to allow one way binding form directive scope to scope outside it.
        scope.openStatus = angular.copy(value);
        if ( value ) {
          accordionCtrl.closeOthers(scope);
        }
      });
      //will open all accordion and break accordian mutual exclusive open behaviour.
      scope.$watch('allOpen', function(value) {
        accordionCtrl.accordionConfig.closeOthers = !value;
        scope.actionToAll(value);
      });
      ...
      //will apply status passed to all accordian which is either open all accordian or close all accordian
      scope.actionToAll = function(value) {
        if ( !scope.isDisabled ) {
          scope.isOpen = value;
        }
      };
